...
public partial class GroundItem : RigidBody2D
{
	...
	private Area2D _pickupCollider;
	...
	public override void _Ready()
	{
		...
		_pickupCollider = GetNode<Area2D>("Area2D");
		_pickupCollider.BodyEntered += OnPickupAreaEntered;
	}
	...
	public void OnPickupAreaEntered(Node2D body)
	{
		...
		(body as Player).PickUpItem(this._item);
		QueueFree();
	}
}
